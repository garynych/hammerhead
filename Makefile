...
ARCH		?= arm
CROSS_COMPILE	?= ~/Android/toolchain/arm-eabi-4.8/bin/arm-eabi-
...
LOW_ARM_FLAGS	= -pipe -marm -mtune=cortex-a15 -mfloat-abi=soft -mfpu=neon-vfpv4 -fno-tree-vectorize -fno-schedule-insns2 -fmodulo-sched -fmodulo-sched-allow-regmoves -fno-inline-functions -fno-pic
